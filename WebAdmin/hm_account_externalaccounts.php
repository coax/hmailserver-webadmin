...
for ($i = 0; $i < $Count; $i++) {
	...
	echo '          <tr>
            ...
            <td><a href="#" onclick="return Confirm(\'Confirm delete <b>' . $Name . '</b>:\',\'Yes\',\'?page=background_account_externalaccount_save&action=delete&domainid=' . $domainid . '&accountid=' . $accountid . '&faid=' . $FAID . '\');" class="delete">Delete</a></td>
            <td><a href="?page=background_account_externalaccount_save&action=downloadnow&domainid=' . $domainid . '&accountid=' . $accountid . '&faid=' . $FAID . '">' . $str_downloadnow . '</a></td>
          </tr>' . PHP_EOL;
}
?>
        </table>
