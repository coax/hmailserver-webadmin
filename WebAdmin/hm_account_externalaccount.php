...
<?php
	PrintPropertyEditRow("ServerAddress", "Server address", $Name, 25);
...
<?php
	PrintPropertyEditRow("Username", "User name", $Name, 25);
	PrintPasswordEntry("Password", "Password", 25);
?>
        </div>
...
?>
          ...
          <p>&nbsp;</p>
          <div style="position:relative; display:inline-block;"><input type="radio" name="DaysToKeepMessages" value="" id="3" <?php if ($DaysToKeepMessages == -1) echo "checked";?>><label for="3"><?php EchoTranslation("Delete messages after")?></label></div>
